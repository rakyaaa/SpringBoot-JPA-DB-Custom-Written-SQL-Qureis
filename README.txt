# SpringBoot-JPA-DB-Custom-Written-SQL-Qureis
In this Project, We have used the Custom Quries written using SQL language
...
LIST ALL EMPLOYEE : localhost:8100/listAllEmployee
